...
export const environment = {
  ...
  // Auth
  LoginUrl: 'http://localhost:8081/tokens/v1',
  LogoutUrl: 'http://localhost:8081/accounts/v1/logout',
  RegisterUrl: 'http://localhost:8081/users/v1/signup',
  PasswordResetInitiateUrl: 'http://localhost:8081/passwords/v1/reset_initiate',
  PasswordResetSubmitUrl: 'http://localhost:8081/passwords/v1/reset_submit',
  AccountActivationUrl: 'http://localhost:8081/accounts/v1/activate',
  GetCustomerPreferencesUrl: 'http://localhost:8081/v1/customers/replace-me/preferences',
  CreateOrUpdateCustomerPreferencesUrl: 'http://localhost:8081/customers/v1/preferences',
  CreateContactsUrl: 'http://localhost:8081/messages/v1',
  UpdatePersonalDetails: 'http://localhost:8081/users/v1/update_personal',
