...
export const environment = {
  ...
  // Auth
  LoginUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/tokens/v1',
  LogoutUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/accounts/v1/logout',
  RegisterUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/users/v1/signup',
  PasswordResetInitiateUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/passwords/v1/reset_initiate',
  PasswordResetSubmitUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/passwords/v1/reset_submit',
  AccountActivationUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/accounts/v1/activate',
  GetCustomerPreferencesUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/v1/customers/replace-me/preferences',
  CreateOrUpdateCustomerPreferencesUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/customers/v1/preferences',
  CreateContactsUrl: 'https://bigtree-auth-service-672f06320174.herokuapp.com/messages/v1',
  UpdatePersonalDetails: 'https://bigtree-auth-service-672f06320174.herokuapp.com/users/v1/update_personal',
  ...
  //GEO
  PostcodeDistrictUrl: 'https://bigtree-geo-78f520f4abb3.herokuapp.com/geo/v1/postcode-districts',
